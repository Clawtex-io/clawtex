...
AI analyses your event history and finds patterns - repeated mistakes, missed steps, things that could be prevented. It proposes corrections as lessons. You approve or reject. Approved lessons are injected at every session start, so your agent gets smarter over time. Runs weekly, automatically.
